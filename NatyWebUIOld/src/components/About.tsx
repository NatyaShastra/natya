...
export const About: React.FC = () => {
  return (
    <div className="page-container">
      ...
      <p>Join us and experience the joy of movement!</p>

      <h2>Contact Us</h2>
      <p>📍 Location: Gachibowli & Tellapur, Hyderabad</p>
      <p>📞 <a href="tel:9160228929">Call us</a> |
       📧 <a href="mailto:NatyaShastra@gmail.com">Email us</a> | 💬 
      <a href="https://wa.me/9344134242" target="_blank" rel="noopener noreferrer">Chat Now </a> WhatsApp (Only escalations)</p>
    </div>
  );
};
